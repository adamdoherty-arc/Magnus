...
def check_dependencies():
    ...
    try:
        ...
        try:
            ...
            print("⚠️  Please install and start Redis manually")
    ...
    try:
        ...
        print("⚠️  PostgreSQL driver not installed (pip install psycopg2-binary)")
        print("   System will use Redis for data storage (limited historical data)")
    except Exception as e:
        print("⚠️  PostgreSQL not configured (optional)")
...
def install_requirements():
    ...
    if critical_missing:
        print(f"\n⚠️ Critical packages missing: {', '.join(critical_missing)}")
...
def main():
    ...
    if not check_dependencies():
        print("\n⚠️  Please fix dependency issues and try again")
        sys.exit(1)
