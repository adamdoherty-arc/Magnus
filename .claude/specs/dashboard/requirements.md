...
- **As a** trader
- **I want** to see live data from Robinhood API, Kalshi API, XTrades API, Discord API
...
- **Header**: 18 instance(s)
- **Metric**: 73 instance(s)
- **Chart**: 3 instance(s)
- **Dataframe**: 6 instance(s)
- **Selectbox**: 6 instance(s)
- **Multiselect**: 2 instance(s)
- **Slider**: 4 instance(s)
- **Button**: 17 instance(s)
- **Tabs**: 2 instance(s)
- **Expander**: 8 instance(s)
- **Columns**: 34 instance(s)
