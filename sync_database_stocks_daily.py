...
- 7-day and 30-day options for theta decay comparison
...
# Setup logging (clear log file each time)
logging.basicConfig(
    level=logging.INFO,
...
TARGET_DTES = [7, 30]  # 7-day and 30-day options for comparison
...
def categorize_error(error_msg: str) -> str:
    ...
    # No options indicators (expanded to catch 404 and None chain errors)
    ...
    # Still unknown - log for debugging
    else:
        logger.warning(f"Unknown error pattern: {error_msg[:200]}")
...
def main():
    ...
    logger.info(f"    Fetching 7-day and 30-day options for theta decay comparison")
    logger.info("    This should take 5-8 minutes...")
